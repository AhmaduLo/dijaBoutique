...
class AchatDtoTest {
    ...
    void fromEntity_planBASIC_photoUrlNull() {
        assertThat(AchatDto.fromEntity(achatAvecPlan(TenantEntity.Plan.BASIC)).getPhotoUrl())
                .isNull();
    }
    ...
    void fromEntity_planPREMIUM_photoUrlVisible() {
        assertThat(AchatDto.fromEntity(achatAvecPlan(TenantEntity.Plan.PREMIUM)).getPhotoUrl())
    ...
    void fromEntity_planENTREPRISE_photoUrlVisible() {
        assertThat(AchatDto.fromEntity(achatAvecPlan(TenantEntity.Plan.ENTREPRISE)).getPhotoUrl())
                .isEqualTo("/photos/tissu.jpg");
    }
    ...
    void fromEntityWithoutUser_planPREMIUM_photoVisibleSansUtilisateur() {
        AchatDto dto = AchatDto.fromEntityWithoutUser(achatAvecPlan(TenantEntity.Plan.PREMIUM));
    ...
    void fromEntity_achatDuJour_champsCalculesCorrects() {
        ...
        AchatDto dto = AchatDto.fromEntity(achatAvecPlan(TenantEntity.Plan.BASIC));
