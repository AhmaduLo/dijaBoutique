...
class CreditControllerTest {
    ...
    void obtenirCredits_retourne200AvecPage() throws Exception {
        when(creditClientService.obtenirCredits(0, 20, null, null, null, null, null))
        ...
        verify(creditClientService).obtenirCredits(0, 20, null, null, null, null, null);
    }
    ...
    void obtenirCredits_filtreParStatut() throws Exception {
        ...
        when(creditClientService.obtenirCredits(0, 20, null, "EN_ATTENTE", null, null, null))
                .thenReturn(pageVide);
        ...
        verify(creditClientService).obtenirCredits(0, 20, null, "EN_ATTENTE", null, null, null);
    }

    @Test
    @DisplayName("GET /credits?search=Ndiaye — filtre par recherche")
    void obtenirCredits_filtreParRecherche() throws Exception {
        when(creditClientService.obtenirCredits(0, 20, "Ndiaye", null, null, null, null))
                .thenReturn(pageResponse);
    ...
    void obtenirCredits_retourneListeVide() throws Exception {
        ...
        when(creditClientService.obtenirCredits(anyInt(), anyInt(), any(), any(), any(), any(), any()))
                .thenReturn(pageVide);
